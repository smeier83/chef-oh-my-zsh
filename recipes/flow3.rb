...
node[:oh_my_zsh][:users].each do |zsh_user|
	...
	script "install flow3 zsh plugin" do
		...
		chown -R vagrant:www-data /home/#{zsh_user}/.oh-my-zsh/custom/plugins/flow3
		chmod 777 /home/#{zsh_user}/.oh-my-zsh/custom/plugins/flow3/helper-postprocess-cmdlist.php
		EOH
